            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <h5 style="margin-top:18px; margin-left:10px">Add Subject</h5>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group form-default">
                                                    <label> Select Cources <span class="required"><i class="bi bi-asterisk"></i></span></label>
                                                    <select class="form-control js-example-basic-single" name="cource" id="cources">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group form-default">
                                                    <label class="float-label">Subject Name <span class="required"><i class="bi bi-asterisk"></i></span></label>
                                        ...
                                        <table id="myDataTable" class="table table-striped table-bordered nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="{{ url('/subject/edit',$s->id)}}" class="btn btn-success">Edit</a>
                                                    <a href="{{ url('/subject/delete',$s->id)}}" onclick="return myConfirm()" class="btn btn-danger">Delete</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
