            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <h5 style="margin-top:18px; margin-left:10px">Answer Sheet</h5>
                                <div class="card-block" style="margin:10px ;">
                                    <form class="form-material" id="" method="POST" action="" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <label>Question Paper Download</label><br>
                                                <a href="" class="btn btn-primary">Question Paper Download</a>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Answer Sheet Download</label><br>
                                                <a href="" class="btn btn-primary">Answer Sheet Download</a>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group form-default">
                                                    <label>Upload Checked Answer Sheet</label>
                                                    <input type="file" name="checkeans" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group form-default">
                                                    <label>Upload Sample Pdf Answer Sheet</label>
                                                    <input type="file" name="checkeans" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group form-default">
                                                    <label>Comment</label>
                                                    <textarea class="form-control" rows="3" cols="9" name="Add_question" id="add_question"></textarea>
                                                </div>
                                            </div>
