...
<div class="container-fluid page-body-wrapper">
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <h2> <a href="{{ url('/subjectivetest') }}"><i class="bi bi-caret-left-fill"></i></a>Test Series</h2>
                            ...
                            <div class="dt-responsive table-responsive" style="margin-top:20px ;">
                                <div class="row">
                                    ...
                                    <tr>
                                      ...
                                      <tr>
                                        <th>Dowload at</th>
                                        <td> <a href="" class="right">Test Paper</a> <a href="" class="right">Solution</a> <a href="" class="right">Upload</a>
                                        </td>
                                      </tr>
                                    </table>
                                </div>
