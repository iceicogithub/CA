...
.menu a:hover{
 ...
 <nav class="sidebar sidebar-offcanvas" id="sidebar">
   ...
   <ul class="nav">
     ...
     <li class="nav-item">
       ...
       <div class="collapse" id="user">
         <ul class="nav flex-column sub-menu">
           ...
           <li class="nav-item"> <a class="nav-link" href="{{url('/listuser')}}">List User</a></li>
     ...
     @endif
     @if( auth()->user()->role == 'add_question,checker' or auth()->user()->role == 'add_question' or Auth::guard('admin')->check())
     <li class="nav-item">
       ...
       <div class="collapse" id="tables">
         <ul class="nav flex-column sub-menu">
           <li class="nav-item"> <a class="nav-link" href="{{url('/add')}}"> Add cources </a> </li>
           <li class="nav-item"> <a class="nav-link" href="{{url('/subject')}}"> Add Subject</a></li>
           <li class="nav-item"> <a class="nav-link" href="{{url('/chapter')}}"> Add Chapter</a></li>
           <li class="nav-item"> <a class="nav-link" href="{{url('/unit')}}"> Add Question</a></li>
         </ul>
       </div>
     </li>
     @endif
     @if(auth()->user()->role == 'add_question' or Auth::guard('admin')->check() or auth()->user()->role == 'add_question,checker')
     <li class="nav-item">
       ...
       <div class="collapse" id="question">
         <ul class="nav flex-column sub-menu">
           <li class="nav-item"> <a class="nav-link" href="{{url('/questionpaper')}}"> Add Question Paper </a> </li>
           <li class="nav-item"> <a class="nav-link" href="{{url('/listquestion')}}">List Question paper</a></li>
         </ul>
       </div>
     </li>
     @endif
     ...
     <li class="nav-item">
       ...
       <div class="collapse" id="ans">
         <ul class="nav flex-column sub-menu">
           <li class="nav-item"> <a class="nav-link" href="{{url('/ans')}}">List Answer Sheet </a> </li>
         </ul>
       </div>
     </li>
     @endif
     @if(auth()->user()->role == 'checker'  or auth()->user()->role == 'add_question,checker')
     <li class="nav-item">
       <a class="nav-link" data-toggle="collapse" href="#ans" aria-expanded="false" aria-controls="tables">
         <i class="icon-grid-2 menu-icon"></i>
         <span class="menu-title">Answer Sheet</span>
     ...
     @endif
     @if(auth()->user()->role == 'checker' or Auth::guard('admin')->check() or auth()->user()->role == 'add_question,checker')
     <li class="nav-item">
       ...
       <div class="collapse" id="qury">
         <ul class="nav flex-column sub-menu">
           <li class="nav-item"> <a class="nav-link" href="{{url('/queries')}}">List Queries</a> </li>
         </ul>
       </div>
     </li>
     @endif
     {{-- <li class="nav-item">
      <a class="nav-link" href="{{url('/dashboard')}}">
        <i class="icon-grid menu-icon"></i>
        <span class="menu-title">Create Paper</span>
      </a>
    </li> --}}
