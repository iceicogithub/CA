                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="card" style="margin-top:30px ; padding:0 20px">
                                <h5 style="margin-top:20px;">Question List</h5>
                                        ...
                                        <table id="myDataTable" class="table table-striped table-bordered nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$s->email}}</td>
                                                    <td>
                                                    <a href="{{ url('/user/edit',$s->id)}}" class="btn btn-success">Edit</a>
                                                    <a href="{{ url('/user/delete',$s->id)}}" onclick="return myConfirm()" class="btn btn-danger">Delete</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
