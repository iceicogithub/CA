                                    ...
                                    ?>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                ?>
                                                    <a href="{{ url('/view', $s->id)}}"
                                                        class="btn btn-default modal-global">View</a>
                                                </td>
                                                <?php
                                                    }
                                                ?>
                                                <td><input data-id="{{$s->id}}" class="toggle-class" type="checkbox"
                                                        data-onstyle="success" data-offstyle="danger"
                                                        data-toggle="toggle" data-on="Active" data-off="InActive"
                                                        {{ $s->status ? 'checked' : '' }}>
                                                    <a class="active"> <?php if($s->status == 1){ ?>
                                                        Active
                                                        <?php } else{ ?>
                                                        InActive
                                                    </a>
