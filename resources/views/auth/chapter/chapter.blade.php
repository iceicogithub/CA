                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group form-default">
                                                    ...
                                                    <select class="form-control js-example-basic-single" id="subject_name" name="subject_name">
                                        ...
                                        <table id="myDataTable" class="table table-striped table-bordered nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$s->status}}</td>
                                                    <td> <a href="{{ url('/chapter/edit',$s->id)}}" class="btn btn-success">Edit</a>
                                                    <a href="{{ url('/chapter/delete',$s->id)}}" onclick="return myConfirm()" class="btn btn-danger">Delete</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
